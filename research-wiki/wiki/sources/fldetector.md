...
- Theory assumes one full-batch GD step; real FL does multi-step local SGD (Flirds' $\Delta w_k$ regime) — the consistency signal under that gap is untested here.
