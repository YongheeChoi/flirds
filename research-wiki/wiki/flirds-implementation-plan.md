...
- **Pipeline stage**: `implementation` — **Phase 1 complete + Phase 2 started** (2026-06-06): #7 FULL scale run DONE (both lr; Flirds selection works) + **SV-baselines port (Phase 2 task 1) DONE** (GTG/FedSV/Ripple → LLM; Flirds dominates — Spearman +1.000 vs (b)oracle at ~5× lower runtime). Details in "Next concrete action" below.
