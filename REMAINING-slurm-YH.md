...
> **진행 상황 (07-26 21:25)**: G3 ✅ **96/96 커밋 `4395028`** · c1축 🟢 **4/9 착지**(1 커밋 `be53009` + 3 미커밋) + 5 실행 · G8 🟡 3 R/21 PD · G6 🟡 9 PD · **G14 🟡 18 PD 제출완료(`1886441`)** · **실패 0**.
> **전량 완주 예상 = 07-27 ~10:40**(임계경로 = c1축 9번째 셀 idx16, 19:26 착수; §7). G14 추가로 makespan 불변.
...
| **P2** | **c1축 `c1axis` `0-7,16`** | 9셀 · **~125 실측** | 🟢 **4/9 착지**(1 커밋 `be53009` + 3 미커밋) · 5 실행 | **본문 G2 의 P0 seed** — C-b 를 쓴 사람이 직접 |
| **P3** | G8 `c2fidmn` | 24런 · ~25–38 | 🟡 3 R / 21 PD | 부록 fidelity+탐지가 한 rundir |
...
phase 분해는 4셀 전부 동일: **(a) 2¹⁰ 재학습 98.8~98.9%** · client-training 0.03h ·
...
| 시점 | 상태 |
|---|---|
| ✅ 07-26 20:18~21:15 | c1축 grad-noise·dir1 free-rider 3셀 추가 착지(**4/9**) |
| 07-26 21:34~22:29 | 1차 웨이브 잔여 4셀 착지(idx0 21:34 · idx1 21:40 · idx5 22:09 · idx4 22:29) |
| 07-26 22:30~ | **7슬롯 개방** → G8 21 + G6 9 + **G14 18** 흡수(계 ~58 GPU-h / 7슬롯 ≈ 8.3 wall-h) |
| 07-27 ~06:00–07:00 | G8·G6·G14 완주 예상(G14 는 꼬리지만 값이 싸 같은 창에 들어감) |
| **07-27 ~10:40** | **idx16 착지 = YH 전량 완주**(임계경로) |
