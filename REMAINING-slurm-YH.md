...
> **진행 상황 (07-26 19:25)**: G3 ✅ **96/96 커밋 `4395028`** · c1축 🟢 **1/9 커밋 `be53009`** + 8 실행 · G8 🟡 24 PD · G6 🟡 9 PD · **실패 0**.
> **전량 완주 예상 = 07-27 ~10:50**(임계경로 = c1축 9번째 셀 idx16, 19:25 착수; §7).
...
| **P2** | **c1축 `c1axis` `0-7,16`** | 9셀 · **~125 실측** | 🟢 1/9 착지 `be53009` · 8 실행 | **본문 G2 의 P0 seed** — C-b 를 쓴 사람이 직접 |
...
**★ 첫 YH 셀 착지로 노드 계수 확정 (07-26 19:25)** — `cifar10_iid_free-rider_seed0`
(커밋 `be53009`) **12.99h**, (a) 46,209s = **45.13s/retrain**, efficiency-gap 8.88e-16.
JB(49.79s) 대비 **0.91×** → 위 seed2 실측표에 ×0.906 을 곱한 값이 YH 예측이다.
phase 분해: **(a) 2¹⁰ 재학습이 98.8%**(12.84h/12.99h) — 이 셀의 비용은 사실상 2¹⁰ 단독.

**예상 종료 (07-26 19:25 기준 재계산)**

| 시점 | 상태 |
|---|---|
| ✅ 07-26 19:25 | c1축 idx2 착지(1/9) → 그 슬롯에서 **9번째 셀(idx16 = seed1 iid clean) 즉시 착수** |
| 07-26 20:07~22:35 | 1차 웨이브 잔여 7셀 순차 착지(grad-noise 13.5h → clean/label-flip 15.4h 순) |
| 07-26 20:10~ | 비는 슬롯이 G8 24 + G6 9 흡수 → 07-27 새벽~오전 완주 |
| **07-27 ~10:50** | **idx16 착지 = YH 전량 완주** |
